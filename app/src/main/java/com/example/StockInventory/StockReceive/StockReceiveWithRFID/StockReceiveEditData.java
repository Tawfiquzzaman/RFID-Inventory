                ...
                try {
                    ...
                    if (con == null) {
                        ...
                        if (Itemcode != null) {
                            ...
                            String queryUpdate128 = "UPDATE [dbo].[Registry] SET [RegValue] = [RegValue]+1 WHERE RegID = 128;";
                            PreparedStatement stmtSUpdate128 = con.prepareStatement(queryUpdate128);
                            stmtSUpdate128.executeUpdate();
...
//                            }
                            ...
                            String queryUpdateItemUOM = "UPDATE [dbo].[ItemUOM] SET [BalQty] = [BalQty]+1 WHERE ItemCode = '"+ Itemcode +"';";
                            PreparedStatement stmtSUpdateItemUOM = con.prepareStatement(queryUpdateItemUOM);
                            stmtSUpdateItemUOM.executeUpdate();

                            String queryUPDATEUTDStockCost = "UPDATE [dbo].[UTDStockCost] SET [UTDQty] = [UTDQty]+1 WHERE [ItemCode] ='"+ Itemcode +"';";
