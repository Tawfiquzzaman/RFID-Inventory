...
import com.example.StockInventory.StockAdjustment.withrfid.listAdapter;
...
public class Adjwithrfid extends AppCompatActivity implements View.OnClickListener, CompoundButton.OnCheckedChangeListener {
...
//                            Log.e("TAG", "Savecode: " + code + "\n" + Oldata);
                        ...
                        Toast.makeText(Adjwithrfid.this, "Data be recorded", Toast.LENGTH_LONG).show();
                        onStop();
                        onStart();
                    }
                }
...
//        if (mToast == null) {
//            mToast = Toast.makeText(Adjwithrfid.this, message, Toast.LENGTH_SHORT);
//            mToast.show();
//        } else {
