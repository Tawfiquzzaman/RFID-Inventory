...
public class stockissue extends AppCompatActivity implements View.OnClickListener, CompoundButton.OnCheckedChangeListener{
...
//                        startActivity(intent);
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_stockissue);
...
//            Toast.makeText(this, "输出成功", Toast.LENGTH_SHORT).show();
        ...
        private void showToast(String message) {
            if (mToast == null) {
                mToast = Toast.makeText(stockissue.this, message, Toast.LENGTH_SHORT);
                mToast.show();
            } else {
