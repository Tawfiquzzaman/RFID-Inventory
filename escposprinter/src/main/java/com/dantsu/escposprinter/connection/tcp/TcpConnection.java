...
public class TcpConnection extends DeviceConnection {
     ...
     */
    public TcpConnection(String address, int port,int ID, int PW) {
        this(address, port, ID, PW, 30);
    }
     ...
     */
    public TcpConnection(String address, int port,int ID, int PW, int timeout) {
        super();
    ...
    public TcpConnection(String toString, int parseInt) {
    }
